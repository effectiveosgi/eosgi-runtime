...
public class WebResourceServletTransitiveTest {

	private final BundleContext context = FrameworkUtil.getBundle(WebResourceServletTransitiveTest.class).getBundleContext();
